...
namespace apoemaMatch.Migrations
{
    ...
    [Migration("20220914101459_avaliacaoFinal")]
    partial class avaliacaoFinal
    {
            ...
            modelBuilder.Entity("apoemaMatch.Models.Criterio", b =>
                {
                    ...
                    b.Property<List<string>>("OpcoesCriterios")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("apoemaMatch.Models.Encomenda", b =>
                {
                    ...
                    b.Property<string>("AvaliacaoSolucionarSelecionadoChamada")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("NotaSolucionarSelecionadoChamada")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("TipoEncomendaOutros")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("apoemaMatch.Models.RespostaCriterio", b =>
                {
                    ...
                    b.Property<List<string>>("OpcoesSelecionadas")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("apoemaMatch.Models.RespostaCriterio", b =>
                {
                    ...
                    b.HasOne("apoemaMatch.Models.Proposta", "Proposta")
